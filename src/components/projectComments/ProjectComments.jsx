...
const ProjectComments = ({ project }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const commentToAdd = {
      ...
      id: Math.random() + user.uid + Math.random(),
    };
  ...
  return (
    <div className='project-comments'>
      ...
      <form className='add-comment' onSubmit={handleSubmit}>
        ...
        <textarea name='new-comment' id='new-comment' required onChange={(e) => setNewComment(e.target.value)} value={newComment}></textarea>
